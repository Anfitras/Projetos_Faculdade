...
public class Produto {
    ...
    public Produto(Long id, String nome, String descricao, String codigoBarras, String categoria, String unidadeMedida, BigDecimal precoCusto, BigDecimal precoVenda, Integer estoqueAtual, Integer estoqueMinimo, Integer validadeDias, Fornecedor fornecedor, Boolean ativo, LocalDateTime criadoEm, LocalDateTime atualizadoEm) {
        this.id = id;
        this.nome = nome;
