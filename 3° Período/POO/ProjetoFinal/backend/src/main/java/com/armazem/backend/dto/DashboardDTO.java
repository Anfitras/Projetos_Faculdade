...
public class DashboardDTO {
    ...
    public DashboardDTO(long totalProdutos, BigDecimal valorTotalEstoque, long produtosEstoqueCritico, List<EstoqueMovimento> ultimasMovimentacoes, BigDecimal faturamentoMensal, BigDecimal gastoMensal, List<ProdutoTopVendaDTO> topProdutosVendidos, Long quantidadeTotalEstoque, List<Produto> produtosBaixoEstoque, List<Venda> ultimasVendas, List<EstoqueMovimento> produtosProximosVencimento) {
