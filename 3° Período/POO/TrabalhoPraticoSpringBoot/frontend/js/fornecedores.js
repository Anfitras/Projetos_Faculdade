    ...
    fornecedores.forEach((fornecedor) => {
      ...
      tr.innerHTML = `
                ...
                <td class="actions-cell">
                    <button onclick="prepararEdicaoFornecedor(${fornecedor.id})" class="btn-warning">Editar</button>
                    <button onclick="deletarFornecedor(${fornecedor.id})" class="btn-danger">Excluir</button>
                </td>
            `;
