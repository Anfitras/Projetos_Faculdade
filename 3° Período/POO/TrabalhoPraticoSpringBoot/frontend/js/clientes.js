    ...
    clientes.forEach((cliente) => {
      ...
      tr.innerHTML = `
                ...
                <td class="actions-cell">
                    <button onclick="prepararEdicaoCliente(${cliente.id})" class="btn-warning">Editar</button>
                    <button onclick="deletarCliente(${cliente.id})" class="btn-danger">Excluir</button>
                </td>
            `;
